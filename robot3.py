...
def replay_command(robot_name, n):
    ...
    # move_commands = list(filter(lambda word: word, 
    # replay = list(filter(lambda n: 
    # return replay


def replay_silent(robot_name):
...
def replay_reversed(robot_name):
...
def valid_command(command):
    ...
    # print(n)
    # print(m)
    return command_name.lower() in valid_commands and (len(arg1) == 0 or is_int(arg1) or arg1 == 'silent' or arg1 == 'reversed' or arg1 == 'reversed silent' or (int(n) and int(m))) 
...
def handle_command(robot_name, command):
    ...
    if command_name == 'off':
        ...
        (do_next, command_output) = replay_reversed(robot_name)
